...
const sliderCategory = document.querySelectorAll('[data-slider="home-category"]');
sliderCategory.forEach(item => slider(item, {
  loop: false,
  slidesPerView: 'auto',
  watchSlidesProgress: true
}));
const sliderAbout = document.querySelectorAll('[data-slider="about-slider"]');
sliderAbout.forEach(item => slider(item, {
  loop: false,
  navigation: {
...
const swiper = new core('.swiper--nav', {
  slidesPerView: 'auto',
  spaceBetween: 6,
  freeMode: true,
  autoHeight: false,
...
sliderInteresting.forEach(item => slider(item, {
  ...
  slidesPerView: 'auto',
  navigation: {
    nextEl: '.interesting-slider-next',
